							...
							<tbody>
								...
								?>
									<tr>
										...
										<!-- <td class="text-right">
											<p> <b><?php echo number_format($row['date_created']) ?></b></p>
										</td> -->
										...
										<td class="d-flex flex-row">
											<button class="btn btn-primary btn-sm mr-2 view_user" type="button" data-id='<?php echo $row['user_id'] ?>'>Details Pembayaran</button>
											<a class="btn btn-success btn-sm text-white" href="./print.php
											" name=" print" type="button" target="_blank">print laporan</a>
										</td>
									</tr>
								<?php endwhile; ?>
							</tbody>
