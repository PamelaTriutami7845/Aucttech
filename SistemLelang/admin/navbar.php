...
<nav id="sidebar" class='mx-lt-5 ml-3 mt-4'>
	...
	<div class="sidebar-list">
		...
		<a href="index.php?page=bids" class="nav-item nav-bids"><span class='icon-field'><i class="fa fa-money-bill-alt"></i></span> History lelang</a>
