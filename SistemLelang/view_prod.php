...
<div class="container-fluid">
	...
	<p>Name: <large><b><?php echo $name ?></b></large>
	</p>
	...
	<div class="col-md-12">
		<button class="btn btn-block btn-sm text-white bg-primary" type="button" id="bid">Bid</button>
	</div>
	<div id="bid-frm">
		<div class="col-md-12">
			<form id="manage-bid">
				...
				<div class="row justify-content-between">
					<button class="btn col-sm-5 bg-primary btn-block btn-sm mr-2 text-white">Submit</button>
					<button class="btn col-sm-5 mt-0 btn-block btn-sm bg-secondary text-white" type="button" id="cancel_bid">Cancel</button>
				</div>
			</form>
		</div>
	</div>
